...
/*
  ...
  Documented further by Joseph Holsten (joseph@josephholsten.com)
*/

class PayPalEWP
{

	private $certificate;    // Certificate resource
	private $certificateFile;    // Path to the certificate file

	private $privateKey;    // Private key resource (matching certificate)
	private $privateKeyFile;    // Path to the private key file

	private $paypalCertificate;    // PayPal public certificate resource
	private $paypalCertificateFile;    // Path to PayPal public certificate file
	private $certificateID; // ID assigned by PayPal to the $certificate.
